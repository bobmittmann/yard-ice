%token 	EOF LT GT LTE GTE EQU NEQ SHL ASR PLUS MINUS BITOR XOR OR MUL DIV MOD BITAND AND LPAREN RPAREN INT FALSE TRUE NULL ID DOT LBKT RBKT COMMA ASSIGN SEMICOLON LBRACE RBRACE FUNCTION VAR IF ELSE WHILE BREAK CONTINUE RETURN INV NOT
%%
