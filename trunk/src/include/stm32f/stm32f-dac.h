...
#define CR_DMAUDRIE2 (1 << 29)
/* This bit is set and cleared by software.
	0: DAC channel2 DMA underrun interrupt disabled
	1: DAC channel2 DMA underrun interrupt enabled */

/* Bits 28 - DAC channel2 DMA enable */
#define CR_DMAEN2 (1 << 28)
/* This bit is set and cleared by software.
	0: DAC channel2 DMA mode disabled
	1: DAC channel2 DMA mode enabled */

/* Bits [27..24] - DAC channel2 mask/amplitude selector */
#define CR_MAMP2_MSK (((1 << (3 + 1)) - 1) << 24)
#define CR_MAMP2_SET(VAL) (((VAL) << 24) & MAMP2_MSK)
#define CR_MAMP2_GET(REG) (((REG) & MAMP2_MSK) >> 24)
...
#define CR_WAVE2_MSK (((1 << (1 + 1)) - 1) << 22)
#define CR_WAVE2_SET(VAL) (((VAL) << 22) & WAVE2_MSK)
#define CR_WAVE2_GET(REG) (((REG) & WAVE2_MSK) >> 22)
...
#define CR_TSEL2_MSK (((1 << (2 + 1)) - 1) << 19) 
#define CR_TSEL2_SET(VAL) (((VAL) << 19) & TSEL2_MSK)
#define CR_TSEL2_GET(REG) (((REG) & TSEL2_MSK) >> 19)
...
#define CR_DMAUDRIE1 (1 << 13) 
/*This bit is set and cleared by software.
	0: DAC channel1 DMA Underrun Interrupt disabled
	1: DAC channel1 DMA Underrun Interrupt enabled */

/* Bit 12 - DAC channel1 DMA enable */
#define CR_DMAEN1 (1 << 12)
/* This bit is set and cleared by software.
0: DAC channel1 DMA mode disabled
1: DAC channel1 DMA mode enabled */

/* Bits [11..8] - DAC channel1 mask/amplitude selector */
#define CR_MAMP1_MSK (((1 << (3 + 1)) - 1) << 8)
#define CR_MAMP1_SET(VAL) (((VAL) << 8) & MAMP1_MSK)
#define CR_MAMP1_GET(REG) (((REG) & MAMP1_MSK) >> 8)
/* These bits are written by software to select mask in wave generation mode or amplitude in triangle generation mode.
	0000: Unmask bit0 of LFSR/ triangle amplitude equal to 1
	0001: Unmask bits[1:0] of LFSR/ triangle amplitude equal to 3
	0010: Unmask bits[2:0] of LFSR/ triangle amplitude equal to 7
...
#define CR_WAVE1_MSK (((1 << (1 + 1)) - 1) << 6)
#define CR_WAVE1_SET(VAL) (((VAL) << 6) & WAVE1_MSK)
#define CR_WAVE1_GET(REG) (((REG) & WAVE1_MSK) >> 6)
...
#define CR_TSEL1_MSK (((1 << (2 + 1)) - 1) << 3)
#define CR_TSEL1_SET(VAL) (((VAL) << 3) & TSEL1_MSK)
#define CR_TSEL1_GET(REG) (((REG) & TSEL1_MSK) >> 3)
...
#define DAC_SWTRIGR 0x04

/* [31..2] Reserved. */

/* Bit 1 - DAC channel2 software trigger */
#define SWTRIGR_SWTRIG2 (1 << 1)
...
#define DAC_DHR12L2 0x18


/* DAC channel2 8-bit right-aligned data holding register */
#define DAC_DHR8R2 0x1C


/* Dual DAC 12-bit right-aligned data holding register */
#define DAC_DHR12RD 0x20


/* DUAL DAC 12-bit left aligned data holding register */
#define DAC_DHR12LD 0x24


/* DUAL DAC 8-bit right aligned data holding register */
#define DAC_DHR8RD 0x28


/* DAC channel1 data output register */
#define DAC_DOR1 0x2C


/* DAC channel2 data output register */
#define DAC_DOR2 0x30
...
#define SR_DMAUDR2 (1 << 29) /* Bits 29 - DAC channel2 DMA underrun flag */
...
#define SR_DMAUDR1 (1 << 13) /* Bits 13 - DAC channel1 DMA underrun flag */
/* This bit is set by hardware and cleared by software (by writing it to 1).
