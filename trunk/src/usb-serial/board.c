...
{
	stm32f_gpio_mode(USART2_RTS, INPUT, 0);
	stm32f_gpio_mode(USART3_RX, INPUT, 0);
}

void pin1_sel_vcc(void)
{
	stm32f_gpio_mode(USART2_RTS, INPUT, 0);
	stm32f_gpio_set(USART2_RTS);
	stm32f_gpio_set(USART3_RX);
	stm32f_gpio_mode(USART2_RTS, OUTPUT, PUSH_PULL | SPEED_LOW);
	stm32f_gpio_mode(USART3_RX, OUTPUT, PUSH_PULL | SPEED_LOW);
}

void pin1_sel_gnd(void)
{
	stm32f_gpio_mode(USART2_RTS, INPUT, 0);
	stm32f_gpio_clr(USART2_RTS);
	stm32f_gpio_clr(USART3_RX);
	stm32f_gpio_mode(USART2_RTS, OUTPUT, PUSH_PULL | SPEED_LOW);
	stm32f_gpio_mode(USART3_RX, OUTPUT, PUSH_PULL | SPEED_LOW);
}
...
{
	stm32f_gpio_mode(USART2_RTS, INPUT, PULL_UP);
...
{
	stm32f_gpio_mode(USART2_RTS, INPUT, PULL_UP);
	stm32f_gpio_mode(USART3_RX, ALT_FUNC, OPEN_DRAIN | PULL_UP);
}
...
{
	stm32f_gpio_mode(USART2_CK, INPUT, 0);
...
void pin2_sel_vcc(void)
{
	stm32f_gpio_mode(USART2_CK, INPUT, 0);
	stm32f_gpio_mode(USART3_TX, INPUT, 0);
	stm32f_gpio_set(USART2_CK);
	stm32f_gpio_set(USART3_TX);
	stm32f_gpio_set(EXTRST1_IO);
	stm32f_gpio_mode(USART2_CK, OUTPUT, PUSH_PULL | SPEED_LOW);
	stm32f_gpio_mode(USART3_TX, OUTPUT, PUSH_PULL | SPEED_LOW);
	stm32f_gpio_mode(EXTRST1_IO, OUTPUT, PUSH_PULL | SPEED_LOW);
}
...
void pin2_sel_gnd(void)
{
	stm32f_gpio_mode(USART2_CK, INPUT, 0);
	stm32f_gpio_mode(USART3_TX, INPUT, 0);
	stm32f_gpio_clr(USART2_CK);
	stm32f_gpio_clr(USART3_TX);
...
void pin2_sel_i2c_scl(void)
{
	stm32f_gpio_mode(USART2_CK, INPUT, 0);
	stm32f_gpio_mode(EXTRST1_IO, INPUT, 0);
	stm32f_gpio_mode(USART3_TX, ALT_FUNC, OPEN_DRAIN | PULL_UP);
}
...
void pin4_sel_input(void)
{
	...
	stm32f_gpio_mode(USART1_RX, INPUT, 0);
}

void pin4_sel_vcc(void)
{
	stm32f_gpio_mode(USART2_RX, INPUT, 0);
	stm32f_gpio_set(USART2_RX);
	stm32f_gpio_set(USART1_RX);
	stm32f_gpio_mode(USART2_RX, OUTPUT, PUSH_PULL | SPEED_LOW);
	stm32f_gpio_mode(USART1_RX, OUTPUT, PUSH_PULL | SPEED_LOW);
}

void pin4_sel_gnd(void)
{
	stm32f_gpio_mode(USART2_RX, INPUT, 0);
	stm32f_gpio_clr(USART2_RX);
	stm32f_gpio_clr(USART1_RX);
	stm32f_gpio_mode(USART2_RX, OUTPUT, PUSH_PULL | SPEED_LOW);
	stm32f_gpio_mode(USART1_RX, OUTPUT, PUSH_PULL | SPEED_LOW);
}
...
{
	stm32f_gpio_mode(USART2_TX, INPUT, 0);
	stm32f_gpio_set(USART2_TX);
	stm32f_gpio_set(USART1_TX);
	stm32f_gpio_mode(USART2_TX, OUTPUT, PUSH_PULL | SPEED_LOW);
	stm32f_gpio_mode(USART1_TX, OUTPUT, PUSH_PULL | SPEED_LOW);
}

void pin5_sel_gnd(void)
{
	stm32f_gpio_mode(USART2_TX, INPUT, 0);
	stm32f_gpio_clr(USART2_TX);
	stm32f_gpio_clr(USART1_TX);
	stm32f_gpio_mode(USART2_TX, OUTPUT, PUSH_PULL | SPEED_LOW);
	stm32f_gpio_mode(USART1_TX, OUTPUT, PUSH_PULL | SPEED_LOW);
}
