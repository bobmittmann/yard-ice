...
#define CCFG_TCMR    (4) /* EBI 0 Chip Select Assignement Register */

#define CCFG_EBICSA         (12) /* EBI Chip Select Assignement Register */

#define CCFG_EBI0_CSA       (16) /* EBI 0 Chip Select Assignement Register */
#define CCFG_EBI1_CSA       (20) /* EBI 1 Chip Select Assignement Register */
#define CCFG_MATRIXVERSION  (236) /* Version Register */

/* CCFG_EBICSA - EBI Chip Select Assignement Register */
