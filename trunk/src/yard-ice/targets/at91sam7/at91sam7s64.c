...
const struct target_arch at91sam7s64_arch = {
	.name = "AT91SAM7S64",
	.model = "generic",
	.vendor = "BORESTE",
	.cpu = &at91sam7_cpu,
...
const struct ice_mem_entry at91sam7s64_mem[] = {
...
const struct target_info at91sam7s64 = {
	.name = "at91sam7s64",
	.arch = &at91sam7s64_arch,
//	.cpu = &at91sam7_cpu,
	.mem = (struct ice_mem_entry *)at91sam7s64_mem,
	...
	.probe = (target_script_t)at9sam7s64_probe
};
