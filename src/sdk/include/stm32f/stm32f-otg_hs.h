...
#define OTG_HS_BCNT ((14 - 4) << 4)
/* 
Indicates the byte count of the received IN data packet.
*/

/* Bits [3..0] - Channel number */
#define OTG_HS_CHNUM ((3 - 0) << 0)
/* 
...
#define OTG_HS_NPTXQTOP ((30 - 24) << 24)
/* 
...
#define OTG_HS_NPTQXSAV ((23 - 16) << 16)
/* 
...
#define OTG_HS_I2CDEVADR ((27 - 26) << 26)
/* 
...
#define OTG_HS_PRODUCT_ID ((31 - 0) << 0)
/* 
...
#define OTG_HS_INEPTXFD ((31 - 16) << 16)
/* 
This value is in terms of 32-bit words.
Minimum value is 16
Maximum value is 512
...
#define OTG_HS_PTXQTOP ((31 - 24) << 24)
/* 
...
#define OTG_HS_PTXQSAV ((23 - 16) << 16)
/* 
...
#define OTG_HS_EPNUM ((14 - 11) << 11)
/* 
Indicates the endpoint number on the device serving as the data source or sink.
*/

/* Bits [10..0] - Maximum packet size */
#define OTG_HS_MPSIZ ((10 - 0) << 0)
/* 
...
#define OTG_HS_XACTPOS ((15 - 14) << 14)
/* 
...
#define OTG_HS_PERSCHIVL ((25 - 24) << 24)
/* 
...
#define OTG_HS_INEPTXFEM ((15 - 0) << 0)
/* 
...
#define OTG_HS_STUPCNT ((30 - 29) << 29)
/* 
...
#define STM32F_OTG_HS_EP0_MPSIZ_GET(DEPCTL) \
	stm32f_otg_fs_ep0_mpsiz_lut[OTG_FS_MPSIZ_GET(DEPCTL)]

#define STM32F_OTG_HS_EP0_MPSIZ_SET(MPSIZ) ((MPSIZ == 64) ? OTG_FS_MPSIZ_64 : \
