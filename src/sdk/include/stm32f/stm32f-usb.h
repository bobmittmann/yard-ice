...
#define EP_ID_MSK (((1 << (3 + 1)) - 1) << 0)
#define EP_ID_SET(VAL) (((VAL) << 0) & EP_ID_MSK)
#define EP_ID_GET(REG) (((REG) & EP_ID_MSK) >> 0)
/* 
...
/* Bits [12..11] - Lost SOF */
#define LSOF_MSK (((1 << (1 + 1)) - 1) << 11)
#define LSOF_SET(VAL) (((VAL) << 11) & LSOF_MSK)
#define LSOF_GET(REG) (((REG) & LSOF_MSK) >> 11)
/* 
...
#define FN_MSK (((1 << (10 + 1)) - 1) << 0)
#define FN_SET(VAL) (((VAL) << 0) & FN_MSK)
#define FN_GET(REG) (((REG) & FN_MSK) >> 0)
/* 
...
#define ADD_MSK (((1 << (6 + 1)) - 1) << 0)
#define ADD_SET(VAL) (((VAL) << 0) & ADD_MSK)
#define ADD_GET(REG) (((REG) & ADD_MSK) >> 0)
/* 
...
USB_EPnR register must match with the information co */
...
#define BTABLE_MSK (((1 << (15 + 1)) - 1) << 3)
#define BTABLE_SET(VAL) (((VAL) << 3) & BTABLE_MSK)
#define BTABLE_GET(REG) (((REG) & BTABLE_MSK) >> 3)
/* 
...
#define EP_TYPE_MSK (((1 << (1 + 1)) - 1) << 9)
#define EP_TYPE_SET(VAL) (((VAL) << 9) & EP_TYPE_MSK)
#define EP_TYPE_GET(REG) (((REG) & EP_TYPE_MSK) >> 9)
/* 
...
#define EA_MSK (((1 << (3 + 1)) - 1) << 0)
#define EA_SET(VAL) (((VAL) << 0) & EA_MSK)
#define EA_GET(REG) (((REG) & EA_MSK) >> 0)
/* 
...
#define ADDRN_TX_MSK (((1 << (15 + 1)) - 1) << 1)
#define ADDRN_TX_SET(VAL) (((VAL) << 1) & ADDRN_TX_MSK)
#define ADDRN_TX_GET(REG) (((REG) & ADDRN_TX_MSK) >> 1)
/* 
