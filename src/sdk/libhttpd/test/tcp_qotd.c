...
"Eileen L. Behr has translated her skill in public speaking into a successful",
"career selling capacitors.",
...
"Facta, non verba.",
"Fairness?  Decency?  How can you expect fairness and decency on a planet of",
"sleeping people?",
...
"and therefore can create value.  -G.W.  Hegel",
...
"How I want a drink, alcoholic of course, after the chapters involving quantum",
"mechanics.",
...
"If some day it should happen that a victim must be found, I've got a little list,",
...
"It is better to light a single candle than to curse the darkness, except at the",
...
"Male tyrannosaurs may have used their diminutive front legs to titillate female",
"partners, but this will not explain why they got so small.  - Gould and Lewontin",
...
"Nothing is capable of being well set to music that is not nonsense.  - Joseph",
"Addison.",
...
"You have been transfixed by the gaze of the Edlund.",
"You have bills.",
"You have had a long-term stimulation relative to business.",
"You have made an excellent hit on the UNIX.",
"You have mail.",
...
const uint16_t qotd_len = sizeof(qotd) / sizeof(char *);

void __attribute__((noreturn)) tcp_qotd_task(void * arg)
{
	struct tcp_pcb * svc;
	struct tcp_pcb * tp;
	int port = 17;
...
uint32_t tcp_qotd_stack[256];

const struct thinkos_thread_inf tcp_qotd_inf = {
	.stack_ptr = tcp_qotd_stack, 
	.stack_size = sizeof(tcp_qotd_stack), 
	.priority = 32,
	.thread_id = 8, 
	.paused = 0,
	.tag = "TCPQOTD"
...
{
	return thinkos_thread_create_inf((void *)tcp_qotd_task, (void *)NULL,
								 &tcp_qotd_inf);
