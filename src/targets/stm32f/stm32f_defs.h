...
#else 
#error "STM32 family undefined or invalid!"
#endif 
...
#define MCO_SYSCLK (0x4 << 24)
#define MCO_HSI    (0x5 << 24)
#define MCO_HSE    (0x6 << 24)
#define MCO_PLL    (0x7 << 24)
...
#define MCO2PRE_4 (0x6 << 27) #define MCO2PRE_5 (0x7 << 27)  
/* MCO2 prescaler
...
/* APB high-speed prescaler (APB2)
   ...
   Caution: The software has to set these bits correctly not to exceed 60 MHz 
   on this domain.
...
/* APB Low speed prescaler (APB1)
   ...
   The clocks are divided with the new prescaler factor 
   from 1 to 16 AHB cycles after PPRE1 write.
   0xx: AHB clock not divided
   100: AHB clock divided by 2
   101: AHB clock divided by 4
   110: AHB clock divided by 8
