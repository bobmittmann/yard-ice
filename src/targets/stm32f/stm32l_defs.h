...
#define VOS      (3 << 11)
#define VOS_1_8V (1 << 11)
#define VOS_1_5V (2 << 11)
#define VOS_1_2V (3 << 11)
...
/* This bit works in conjunction with ULP bit.
   ...
   The VREFINTRDYF flag in the CSR register indicates when the 
...
/* PVD level selection. */
#define PLS (0x7 << 5)
#define PLS_1_9V (0x0 << 5)
#define PLS_2_1V (0x1 << 5)
#define PLS_2_3V (0x2 << 5)
#define PLS_2_5V (0x3 << 5)
#define PLS_2_7V (0x4 << 5)
#define PLS_2_9V (0x5 << 5)
#define PLS_3_1V (0x6 << 5)
#define PLS_EXT  (0x7 << 5)
...
of CR register.
This bit is reset when VOS[1:0] in CR register change.
