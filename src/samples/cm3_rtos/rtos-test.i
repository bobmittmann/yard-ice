...
uint32_t stack[4][512 / 4];
volatile struct my_arg arg[4];
...
void speed_test(void)
{
 ...
 th[0] = cm3rtos_thread_create(yield_task, (void *)&arg[0],
          stack[0], 512, 1);
 th[1] = cm3rtos_thread_create(yield_task, (void *)&arg[1],
          stack[1], 512, 1);
 th[2] = cm3rtos_thread_create(yield_task, (void *)&arg[2],
          stack[2], 512, 2);
 th[3] = cm3rtos_thread_create(yield_task, (void *)&arg[3],
          stack[3], 512, 2);
...
void busy_test(void)
{
 ...
 th[0] = cm3rtos_thread_create(busy_task, (void *)&arg[0],
          stack[0], 512, 2);
 th[1] = cm3rtos_thread_create(busy_task, (void *)&arg[1],
          stack[1], 512, 4);
 th[2] = cm3rtos_thread_create(busy_task, (void *)&arg[2],
          stack[2], 512, 6);
 th[3] = cm3rtos_thread_create(busy_task, (void *)&arg[3],
          stack[3], 512, 8);
 printf("  * Threads: %d, %d, %d, %d\n", th[0], th[1], th[2], th[3]);
...
int main(int argc, char ** argv)
{
 ...
 stdout = stm32f_usart_open(((struct stm32f_usart *)0x40005000), 115200, ((2 << 0) | (0 << 3) | (0 << 6)));
