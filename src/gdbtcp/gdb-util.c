...
unsigned long long hex2uint64_be(const char * __s, char ** __endp)
{
...
int rsp_decoder_lookup(const struct rsp_pkt_decoder lst[], 
					   unsigned int len, int key)
{
	int i = 0;
    int j = len - 1;
