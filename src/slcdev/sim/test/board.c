...
static void io_leds_init(void)
{
	...
	stm32_gpio_mode(LED1, OUTPUT, PUSH_PULL | SPEED_MED);
	stm32_gpio_mode(LED2, OUTPUT, PUSH_PULL | SPEED_MED);
	stm32_gpio_mode(LED3, OUTPUT, PUSH_PULL | SPEED_MED);
	stm32_gpio_mode(LED4, OUTPUT, PUSH_PULL | SPEED_MED);
