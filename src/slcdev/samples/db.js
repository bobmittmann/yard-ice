{
	...
	"sensor": { 
		"model" : "AP Ion", 
		"desc" : "AP Ionization Smoke Detector", 
		"sim" : "ap_ion", 
		"ap": true,
		"pw1" : [270, 330],
		"pw2" : [
	...
	"sensor": { 
		"model" : "AP Photo", 
		"desc" : "AP Photoelectric Smoke Detector", 
		"sim" : "ap_photo", 
		"ap": true,
		"pw1" : [270, 330],
		"pw2" : [
	...
	"sensor": { 
		"model" : "AP Acclimate", 
		"desc" : "AP Multicriteria Photoelectric Smoke Detector", 
		"sim" : "ap_acclimate", 
		"ap": true,
		"pw1" : [280, 320],
		"pw2" : [
	...
	"sensor": { 
		"model" : "AP COPTIR", 
		"sim" : "ap_coptir", 
		"desc" : "AP Multicriteria Smoke Detector", 
		"ap": true,
		"pw1" : ["Reference", 285, 315],
		"pw2" : [
			["Remote test disabled", 285, 315],
	...
	"module": { 
		"model": "AP Control", 
		"desc": "AP Supervised Control Module", 
		"sim" : "ap_control", 
		"ap": true,
		"pw1": [240, 360], 
		"pw2": [ 
	...
	"base": { 
		"model": "AP-sounder-base", 
		"desc": "AP Sounder Base", 
		"sim" : "ap_base" 
		"ap": true,
	}
}
