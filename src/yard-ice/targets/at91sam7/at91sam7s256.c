...
const struct target_arch at91sam7s256_arch = {
	.name = "AT91SAM7S256",
	.model = "generic",
	.vendor = "BORESTE",
	.cpu = &at91sam7_cpu,
...
const struct ice_mem_entry at91sam7s256_mem[] = {
	...
	{ .name = "flash", .flags = MEM_32_BITS,
		...
		.blk = {.count = 1024, .size = 256},
		.op = &flash_at91sam7_256_oper
	},
...
const struct target_info at91sam7s256 = {
	.name = "at91sam7s256",
	.arch = &at91sam7s256_arch,
//	.cpu = &at91sam7_cpu,
	...
	.probe = (target_script_t)at9sam7s256_probe
};
