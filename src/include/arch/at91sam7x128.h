...
/** 
 * @file arch/at91sam7s128.h
 * @brief ARM CPU macros and definitions 
 * @author Robinson Mittmann <bobmittmann@gmail.com>
 */


#ifndef __AT91SAM7X128_H__
#define __AT91SAM7X128_H__
...
/* Internal SRAM size in byte (32 Kbytes) */
#define AT91_ISRAM_SIZE	 0x00008000 

/* IFLASH */
/* Internal FLASH base address */
#define AT91_IFLASH 0x00100000 
/* Internal FLASH size in byte (128 Kbytes) */
#define AT91_IFLASH_SIZE 0x00020000 
...
/* Internal FLASH Number of Pages: 512 bytes */
#define AT91_IFLASH_NB_OF_PAGES 512 
/* Internal FLASH Number of Lock Bits: 8 bytes */
#define AT91_IFLASH_NB_OF_LOCK_BITS 8 
