...
/** 
 * @file arch/at91sam7xc256.h
 * @brief ARM CPU macros and definitions 
 * @author Robinson Mittmann <bobmittmann@gmail.com>
 */


#ifndef __AT91SAM7XC256_H__
#define __AT91SAM7XC256_H__
...
#define PA10_DTXD      (PIO_PA10)
#define PIO_PA11       (1 << 11) /* Pin Controlled by PA11 */
#define PA11_NPCS0     (PIO_PA11) 
...
#define PA20_IRQ0    (PIO_PA20) /* CAN Transmit */
...
#define PA3_TWD      (PIO_PA3) /* SPI 1 Peripheral Chip Select 2 */
#define PIO_PA30       (1 << 30) /* Pin Controlled by PA30 */
#define PA30_IRQ1     (PIO_PA30) /* External Interrupt 0 */
...
#define PA4_TWCK     (PIO_PA4) /* SPI 1 Peripheral Chip Select 3 */
...
#define AT91_ID_AES    (18) /* Advanced Encryption Standard 128-bit */
#define AT91_ID_TDES   (19) /* Triple Data Encryption Standard */
#define AT91_ID_IRQ0   (30) /* Advanced Interrupt Controller (IRQ0) */
#define AT91_ID_IRQ1   (31) /* Advanced Interrupt Controller (IRQ1) */
#define ALL_INT   (0xC00FFFFF) /* ALL VALID INTERRUPTS */
