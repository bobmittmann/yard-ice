...
assign_or_call	: INT_VAR '=' int_exp { op_assign } ';'
				| INT_FUN function_call { op_ret_discard } ';'
				| FIX_VAR '=' fix_exp { op_assign } ';'
				| FIX_FUN function_call { op_ret_discard } ';'
				| BOOL_VAR '=' bool_exp { op_assign } ';'
...
var_assign		: int_exp { op_int_assign }
				| fix_primary_exp { op_fix_assign }
				;
...
int_unary_exp	: int_primary_exp
				| '~' int_unary_exp { op_inv }
				| '-' int_unary_exp { op_minus }
				;

int_primary_exp	: INT { op_push_int }
				| CHAR { op_push_int }
				| INT_VAR
